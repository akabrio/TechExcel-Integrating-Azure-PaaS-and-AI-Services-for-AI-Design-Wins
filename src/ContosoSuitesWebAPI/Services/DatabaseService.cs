...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The Date and Time of the Booking")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Booking with Missing Hotel Rooms.")]
    ...
    [KernelFunction]
    [Description("Booking With Multiple Hotel Rooms.")]
